...
public class ModBlockEntities {
    ...
    public static final Supplier<BlockEntityType<SpectacleCandleBlockEntity>> SPECTACLE_CANDLE = RegistryHelper.registerBlockEntityType("spectacle_candle", () -> PlatformHelper.createBlockEntity(SpectacleCandleBlockEntity::new, ModBlocks.SPECTACLE_CANDLE.get(), ModBlocks.SPECTACLE_CANDLE_CAKE.get()));
    public static final Supplier<BlockEntityType<RoseQuartzChimesBlockEntity>> ROSE_QUARTZ_CHIMES = RegistryHelper.registerBlockEntityType("rose_quartz_chimes", () -> PlatformHelper.createBlockEntity(RoseQuartzChimesBlockEntity::new,  ModBlocks.ROSE_QUARTZ_CHIMES.get()));
    ...
    public static final Supplier<BlockEntityType<ReceiverBlockEntity>> REDSTONE_RECEIVER = RegistryHelper.registerBlockEntityType("redstone_receiver", () ->
            PlatformHelper.createBlockEntity(ReceiverBlockEntity::new,
